    ...
    return (
        <div className="Navbar">
            <div className="text-center w-full flex justify-center flex-row items-center">
                ...
                {location.pathname === "/rankings" && <div className={`md:text-[32px] text-[10px] text-black absolute left-4 mx-4`}>{props.totalVotes} total votes <span className="hidden lg:inline">worldwide</span></div>}
                <div>
